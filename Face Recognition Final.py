...
def clean():
    for f in os.listdir(r"C:\Users\brarj\OneDrive\Desktop\Final Face Reco\only_name"):
        os.remove(fr"C:\Users\brarj\OneDrive\Desktop\Final Face Reco\only_name\{f}")
...
def save_img(imagesz,nami):
    savedImg=os.listdir(r"C:\Users\brarj\OneDrive\Desktop\Final Face Reco\only_name")
    if nami not in savedImg:
        cv2.imwrite(fr"C:\Users\brarj\OneDrive\Desktop\Final Face Reco\only_name\{nami}.jpg", imagesz)
...
def attendance():
    ...
    ff.close()
    os.startfile(r"C:\Users\brarj\OneDrive\Desktop\Final Face Reco\Attendance.csv")
...
def take_a_pic():
    ...
    if new_name in del_names:
        ...
        cv2.imwrite(rf"C:\Users\brarj\OneDrive\Desktop\Final Face Reco\ImagesAttendance\{new_name}", new_img)
        ...
        images.append(cv2.imread(fr'C:\Users\brarj\OneDrive\Desktop\Final Face Reco\ImagesAttendance\{new_name}'))
...
def open_images_to_delete():
    L1 = image_names
    L2 = []
    li2 = os.listdir(r"C:\Users\brarj\OneDrive\Desktop\Final Face Reco\ImagesAttendance")
...
def show():
    os.startfile(r"C:\Users\brarj\OneDrive\Desktop\Final Face Reco\only_name")


def know_faces():
    os.startfile(r"C:\Users\brarj\OneDrive\Desktop\Final Face Reco\ImagesAttendance")


def about():
    os.startfile(r"C:\Users\brarj\OneDrive\Desktop\Final Face Reco\ABOUT OURSELVES.png")
